(function (e) {
    ...
    var c = {
        majorVersion: "3", minorVersion: "5.3", releaseDate: "2012-06-19", _init: function () {
...
tinymce.util.Quirks = function (d) {
    var l = tinymce.VK, s = l.BACKSPACE, t = l.DELETE, o = d.dom, C = d.selection, r = d.settings;
    ...
    function n() {
        function E(F, G) {
            tinymce.each(o.select("a"), function (J) {
                var H = J.parentNode, I = o.getRoot();
                if (H.lastChild === J) {
                    while (H && !o.isBlock(H)) {
...
(function (a) {
    a.Formatter = function (aa) {
        var Q = {}, T = a.each, c = aa.dom, r = aa.selection, t = a.dom.TreeWalker, N = new a.dom.RangeUtils(c),
            d = aa.schema.isValidChild, H = c.isBlock, m = aa.settings.forced_root_block, s = c.nodeIndex,
            G = a.isGecko ? "\u200B" : "\uFEFF", e = /^(src|href|style)$/, X = false, C = true, P, D,
                ...
                aa.onNodeChange.addToTop(function (af, ae, ah) {
                    ...
                    T(P, function (aj, ak) {
                        T(ag, function (al) {
                            if (y(al, ak, {}, true)) {
                                if (!ac[ak]) {
                                    T(aj, function (am) {
                                        am(true, {node: al, format: ak, parents: ag})
                                    });
                                    ac[ak] = aj
                                }
                                ai[ak] = aj;
                    ...
                    T(ac, function (aj, ak) {
                        if (!ai[ak]) {
                            delete ac[ak];
                            T(aj, function (al) {
                                al(false, {node: ah, format: ak, parents: ag})
                            })
                        }
                    })
                })
...
(function (b) {
    ...
    b.EnterKey = function (f) {
        ...
        function g(A) {
            var v = e.getRng(true), E, j, z, u, p, L, o, k, n, t, I, x, B;
