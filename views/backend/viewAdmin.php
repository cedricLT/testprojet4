...
<form name="formulaire" id="formulaire" action="indexAdmin.php?action=adChapter" method="post">
    ...
    <label for="titre">Titre</label> : <input type="text" name="title" id="title" /><br /><br />
    <label for="chapter_number">Numero du chapitre</label> : <input type="text" name="chapter_number" id="chapter_number" /><br /><br />
