        ...
        <div id="blockCommentaires">
            ...
            <?php while ($chapitre = $chapitres->fetch()) { ?>
                ...
                <div id="liens">
                    ...
                    <div class="lien">
                        <a id="voirChapter" href="indexAdmin.php?action=voirChapter&id=<?= $chapitre['id'] ?>">Voir le
                            chapitre</a>
                        <a id="modif" href="indexAdmin.php?action=modifier&id=<?= $chapitre['id'] ?>">Modifier</a>
                        <a id="comments" href="indexAdmin.php?action=voirCommentaire&id=<?= $chapitre['id'] ?>">Voir les
                            commentaires</a>
                        <br/>
            ...
            while ($donnees = $signalerCommentaire->fetch()) { ?>
                ...
                <div class="signalement">
                    ...
                    <p class="text">Commentaire
                        : <?php echo nl2br(htmlspecialchars($donnees['text']));// On affiche le contenu du commentaire
                        ?></p>
